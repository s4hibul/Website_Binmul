...
// import { Auth, signInWithEmailAndPassword, GoogleAuthProvider, signInWithPopup } from 'firebase/auth'; // Pastikan Anda mengimpor dengan benar
// import { getAuth } from 'firebase/auth'; // Pastikan Anda mengimpor dengan benar
// import { app } from '@/firebase-config'; // Pastikan Anda mengimpor dengan benar
...
//                 }
//             } else {
//                 // Tangani kesalahan lain jika bukan objek
//                 setError('Terjadi kesalahan saat masuk. Silakan coba lagi.');
//                 console.error(error);
//             }
//         }
...
//     //         .then(() => {
//     //         alert("Email atur ulang kata sandi telah dikirim. Periksa email Anda.");})
//     //         .catch((error) => {
//     //         alert(error.message);
//     //         });
//     //     } else {
...
function LoginForm() {
    ...
    const signInWithGoogle = async () => {
        try {
            const result = await signInWithPopup(auth, googleAuth);
            console.log("Result before sign in:", result);
            router.push('/beranda');
        } catch (error) {
            console.error(error);
        }
